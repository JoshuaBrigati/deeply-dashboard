...
**Note:** The AI Insight feature requires an Anthropic API key. Get one at [console.anthropic.com](https://console.anthropic.com/). Without the key, the insight card will show an error state.
...
│   │   ├── InsightCard.tsx        # AI-powered insight card
